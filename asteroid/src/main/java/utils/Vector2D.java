...
public class Vector2D {
	...
	public Vector2D(UnitVector2D uVector, double speed) {
		this.setLocation(uVector.getX() * speed, uVector.getY() * speed);
		this.setModule(speed);
	}
	...
	public UnitVector2D asUnitVector() {
		return new UnitVector2D(getX(), getY());
	}
